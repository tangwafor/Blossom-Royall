...
| Catalog and inventory governance | Development verified, production migration approval pending | Product and variant create, read, update, and remove controls; vendor submission; owner approval, rejection, suspension, and publication; onsite, online, and preorder channels; apparel, shoe, ring, bracelet, necklace, and custom measurement metadata; reserved stock; reorder thresholds; atomic stock adjustment; inventory movements; audit history; and tenant isolation passed in disposable PostgreSQL 17. Production compatibility was checked against all 173 existing draft products and variants. |
